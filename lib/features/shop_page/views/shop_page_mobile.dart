...
class ShopPageMobile extends StatelessWidget {
  ShopPageMobile({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Bookstar',
          style: AppTextStyles.headline(context).copyWith(fontSize: 24, color: AppColors.appBarBackground),
        ),
      ),
      body: SafeArea(
        child: Column(
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Icon(Icons.search, color: Color.fromARGB(123, 37, 43, 66),),
          suffixIcon: Obx(() {
...
class _BookCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = (screenWidth - (AppSpacing.md * 3)) / 2; // 2 columns
              ...
              AspectRatio(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (_, __, ___) => Container(
                    ...
                    child: const Icon(Icons.block_outlined, size: 40, color: Colors.grey),
                  ),
                ),
              ),
              const SizedBox(height: AppSpacing.sm),
